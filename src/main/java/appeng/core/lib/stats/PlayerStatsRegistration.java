...
public class PlayerStatsRegistration
{
	...
	/**
	 * is true if the {@link appeng.core.lib.features.AEFeature#Achievements} is enabled in the
	 * 
	 * @param config
	 */
	 ...
	 * {@link appeng.core.lib.AEConfig}.
	 *
	 * @param bus {@see #bus}
	 * @param config {@link appeng.core.lib.AEConfig} which is used to determine if the
	 * {@link appeng.core.lib.features.AEFeature#Achievements} is enabled
	 */
	...
	/**
	 * Registers the {@link appeng.core.lib.stats.AchievementCraftingHandler} and
	 * {@link appeng.core.lib.stats.AchievementPickupHandler} to the {@link #bus} if {@link #isAchievementFeatureEnabled} is
	 * true.
	 */
	...
	/**
	 * Registers the {@link appeng.core.lib.stats.AchievementHierarchy} and adds all {@link appeng.core.lib.stats.Achievements}
