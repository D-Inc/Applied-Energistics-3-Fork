...
public class TileDefinitionBuilder<T extends TileEntity> extends DefinitionBuilder<Class<T>, ITileDefinition<T>, TileDefinitionBuilder<T>> implements ITileBuilder<T, TileDefinitionBuilder<T>>
{
	...
	private IDefinitions<Block, IDefinition<Block> > blockDefinitions;

	public TileDefinitionBuilder( FeatureFactory factory, ResourceLocation registryName, Class<T> tile, IDefinitions<Block, IDefinition<Block>> blockDefinitions )
	{
	...
	protected ITileDefinition<T> def( Class<T> t )
	{
		...
		return new TileDefinition<T>( registryName, t, blockDefinitions.get( registryName ) );
	}
