...
public final class EntityTinyTNTPrimed extends EntityTNTPrimed implements IEntityAdditionalSpawnData
{
	...
	public void onUpdate()
	{
		...
		{
		AppEngCore.INSTANCE.<Item, CoreItemDefinitions>definitions( Item.class ).blockTinyTNT().maybeStack( 1 ).ifPresent( tntStack -> {
	...
	void explode()
	{
		...
		CommonHelper.proxy.sendToAllNearExcept( null, this.posX, this.posY, this.posZ, 64, this.world, new PacketMockExplosion( this.posX, this.posY, this.posZ ) );
	}
