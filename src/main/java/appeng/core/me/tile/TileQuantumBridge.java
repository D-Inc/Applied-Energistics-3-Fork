...
import appeng.core.me.grid.cluster.implementations.QuantumCalculator;
...
public class TileQuantumBridge extends AENetworkInvTile implements IAEMultiBlock, ITickable
{
	...
	public EnumSet<AEPartLocation> getConnections()
	{
		...
		{
			final TileEntity te = this.world.getTileEntity( d == AEPartLocation.INTERNAL ? this.pos : this.pos.offset( d.getFacing() ) );
