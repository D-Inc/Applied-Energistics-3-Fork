...
public class ContainerQNB extends AEBaseContainer
{
	...
	public ContainerQNB( final InventoryPlayer ip, final TileQuantumBridge quantumBridge )
	{
		...
		this.addSlotToContainer( ( new SlotRestrictedInput( SlotRestrictedInput.PlacableItemType.SINGULARITY, quantumBridge, 0, 80, 37, this.getInventoryPlayer() ) ).setStackLimit( 1 ) );
