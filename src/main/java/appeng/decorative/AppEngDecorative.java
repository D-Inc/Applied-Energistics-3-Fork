...
public class AppEngDecorative implements Module
{

	public static final String MODID = AppEng.MOD_ID + "|decorative";

	public static final String NAME = AppEng.MOD_NAME + " | decorative";
